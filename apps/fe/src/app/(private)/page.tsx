  ...
  return (
    <>
      <div className="flex-1 bg-gray-100 dark:bg-gray-950">
        <header className="flex items-center justify-between bg-white px-6 py-4 shadow-sm dark:bg-gray-900">
          ...
          <div className="flex items-center gap-4">
            <Input
              className="max-w-xs rounded-md border border-gray-300 bg-white px-4 py-2 text-sm shadow-sm focus:border-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-50 dark:focus:border-gray-600 dark:focus:ring-gray-600"
              placeholder="Search..."
              type="search"
            />
            <Avatar>
